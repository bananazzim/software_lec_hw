...
if __name__ == "__main__":
    # 20일 전 날짜 기준 (기존 코드 세팅 유지)
    target_date = datetime.now() - timedelta(days=20)
    
    # 3개 사이트 데이터 수집 및 병합
    all_news = fetch_bizinfo(target_date) + fetch_mafra(target_date) + fetch_koat(target_date)
